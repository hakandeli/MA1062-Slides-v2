...
\begin{tikzpicture}[x=2cm, y = 1cm]
    ...
    \begin{scope}[x=0.1cm, y= 0.2cm, shift = {(1.85cm, 0.52cm)}, visible on = <2->]
    ...
    \node[layer, minimum height = 10mm, minimum width = 3mm, fill = BrickRed!50, visible on = <2->] (output) at (1.64, 0) {\tiny\rotatebox{90}{\textcolor{black}{policy}}};

    \node[rectangle, shading = axis, left color = Apricot!20, right color = white, rounded corners = 3pt, minimum height = 10mm, minimum width = 3mm, anchor = center, visible on = <2->] (post) at (2, 0) {};
    ...
    \begin{scope}[x=0.1cm, y= 0.2cm, shift = {(1.85cm, 0.52cm)}, visible on = <3->]
