...
\begin{tikzpicture}[x = 2cm, y = 2cm, > = Stealth]
    ...
    \begin{scope}[shift={(10cm,-3.5cm)}]
        ...
        \node[circle, draw = black, minimum size = 2cm, line width = 0.5pt, anchor = center, fill = white, visible on = <2->] (state) at (-2*\rc, 0) {state};
        
        \node[circle, draw = black, minimum size = 2cm, line width = 0.5pt, anchor = center, fill = white, visible on = <3->] (policy) at (-0.293*\rc, 0.707*\rc) {policy $\pi$};

        \node[circle, draw = black, minimum size = 2cm, line width = 0.5pt, anchor = center, fill = white, visible on = <4->] (update) at (-0.293*\rc, -0.707*\rc) {update};
