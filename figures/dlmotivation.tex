\begin{tikzpicture}[x=5cm, 
                    ...
                    arrowbold/.style={-{Latex[length=3mm, width=5mm]}, draw = MidnightBlue!80, line width = 5pt},
                    on grid]
    ...
    \node[bgrectw, minimum width = 3cm, minimum height = 1.2cm, align = center, anchor = center, visible on = <2->] (n3) at (0, -0.7) {how incorporate \\ potential optimum?};
    \node[bgrectw, minimum width = 4.4cm, minimum height = 1.2cm, align = center, anchor = center, visible on = <3->] (n4) at (1, -0.7) {supervised \\ deep learning (DL)};
    ...
    \draw[arrowbold, visible on = <2->] (n2.north)++(0,1.05) -- node[right, xshift = 2mm] {current research} (n2.north);
    \draw[arrow,  visible on = <2->] (n2) -- (n3);
    \draw[arrow,  visible on = <3->] (n3) -- (n4);
    \draw[arrowbold, visible on = <3->] (n4.north)++(0,1.05) -- node[right, xshift = 2mm] {this thesis} (n4.north);
