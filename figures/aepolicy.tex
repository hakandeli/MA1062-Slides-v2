...
\begin{tikzpicture}[x=2cm, y = 1cm]
    ...
    \begin{scope}
        ...
        \node[align = center, visible on = <1->] (input) at (-3, 0) {demand and \\ topology info};
        ...
        \node[rectangle, draw = black, rounded corners = 3pt, anchor = center, minimum width = 4mm, minimum height = 10mm] (preb) at (-2,-0.5) {\rotatebox{90}{basic encoding}};

        %Enc1
        \begin{scope}[shift={(-1, 0.7)}]
