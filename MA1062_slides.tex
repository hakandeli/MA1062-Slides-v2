...
\begin{frame}{Policymix for RSA Problem}
    \begin{textblock}{7}(1.0, 1.75)
                ...
                \end{itemize}
    \end{textblock}
	\begin{textblock}{5}(9.5, 1.75)
        \begin{figure}[ht]
            \centering
            \input{figures/policymixstats.tex}
            \vspace{0cm}
            \captionsetup{justification=centering}
            \caption*{number of Internet users from 2018 - 2023}
        \end{figure}
    \end{textblock}
\end{frame}

% \begin{frame}{Policymix for RSA Problem}{Policymix Model Architecture}
% 	\begin{textblock}{5}(1, 2)
